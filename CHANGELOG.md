...
- Seznam podporuje filtr a seskupení podle názvu napříč hrami, přehled ukazuje společné sázky, výhry a bilanci jednotlivých skupin včetně archivovaných tiketů a odkazem otevře tikety skupiny v seznamu (aplikace)
