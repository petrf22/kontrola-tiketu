 ...
 *
 * Potřebuje to aplikace při stažení i importu dalšího balíku. Klíčem je dvojice hra a datum —
 * číslo tahu výherní listina neuvádí a jeden den se může losovat víc her.
 */
