...
/**
 * Celý tok aplikace na jednom místě: balík výsledků → sloučení s tím, co už je uložené
 * → vyhodnocení tiketu. Přesně tohle dělá služba Stav, jen bez Angularu, takže se to dá
 * ověřit deterministicky a bez prohlížeče.
 *
 * Balík je skutečný výstup backendu, ne ručně psaný — jinak by test neověřoval nic o tom,
